...
Route::post('/search', 'App\Http\Controllers\FlightSearchController@searchFlights')->name('search.index');
...
Route::get('/test', 'App\Http\Controllers\SearchController@search')->name('test.index');
