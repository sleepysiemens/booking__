...
{
    public function index($params, bool $asAttachment = false): Dompdf|RedirectResponse
    {
        ...
        return $dompdf->stream('Бронирование билета #'.$order->number.'.pdf', array('Attachment' => $asAttachment));
    }

    public function download($params)
    {
        return $this->index($params, true);
    }
}
